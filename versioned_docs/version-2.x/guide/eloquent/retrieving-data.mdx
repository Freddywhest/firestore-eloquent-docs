...
:::info[Note]
With version >= 2.x of the library, to get the data of the document, you need to call the `data()` method on the retrieved document. This method returns the data of the document as an object.<br />
...
$filteredUsers = User::where(['age', '=', 25])->get();// index.blade.php
